...
> If we run the application at this point, the "Get People using Task" link will work the same as the "Get People using Await" link. It will take at least 7 seconds to complete.  
